  ...
  render() {
    ...
    return this.state.loading === true ? <h1 className="m-20">Loading</h1> : (
        ...
        <Switch>
            ...
            <PrivateRoute authed={this.state.authed} path="/ingestionupdatewizzard/:page" name="Ingestion" component={Full}/>
            <PrivateRoute authed={this.state.authed} path="/ingestionupdatewizzard" name="Ingestion" component={Full}/>
